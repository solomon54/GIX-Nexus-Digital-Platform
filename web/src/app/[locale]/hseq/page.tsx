...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    "GIX Nexus HSEQ Policy — Health, Safety, Environment & Quality. Zero Accident Objective and 100% safety-first approach on every telecom and power engineering project across Ethiopia.";
  return {
    title,
    description,
    alternates: {
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <section className="relative py-24 overflow-hidden">
        <PageHeroCarousel
          slides={[
            ...
            {
              src: "/images/industries/safety-equipment.jpg",
      ...
      <section
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            <div
              className="col-span-1 lg:col-span-2 rounded-2xl overflow-hidden border"
              ...
              <div className="relative h-56">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(6,18,54,0.60), rgba(6,18,54,0.08))",
                  }}
                />
                <div className="absolute bottom-4 left-6">
                  <p className="text-xs font-semibold uppercase tracking-widest text-[#00C97A]">
                    HSEQ Policy
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="inline-flex items-center gap-1.5 rounded-full border border-[#00C97A]/30 bg-[#00C97A]/10 px-2.5 py-0.5 mb-2">
                      <span className="text-xs font-semibold text-[#00C97A]">
                        {t("safetyFirstBadge")}
                      </span>
                    </div>
                    <h3
      ...
      <section
        className="pt-20 pb-40 sm:pb-48 md:pb-56 lg:pb-64 pre-footer-wrap section-top-divide bg-section-even"
        style={{ position: "relative" }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">

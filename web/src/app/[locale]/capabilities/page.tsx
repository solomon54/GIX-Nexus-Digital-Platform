    ...
    <>
      ...
      <section className="relative py-28 overflow-hidden">
        <PageHeroCarousel slides={[
          { src: '/images/capability/our-capabilities.webp', motion: 'hero-drift-tr' },
          { src: '/images/capability/test-instruments.jpg', motion: 'hero-drift-up' },
              ...
              <div key={member.id} className="rounded-xl border overflow-hidden group transition-all hover:border-[var(--accent)]/30" style={{ background: '#FFFFFF', borderColor: 'var(--border)' }}>
                ...
                <div className="relative h-48" style={{ background: 'linear-gradient(135deg, #050D1A, #0D1829)' }}>
                  {member.photoUrl ? (
                    ...
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" className="object-cover hero-pan" />
                  ) : (

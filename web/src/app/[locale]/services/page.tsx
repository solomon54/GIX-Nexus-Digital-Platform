...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    "GIX Nexus services: Telecommunications Infrastructure, Fiber Optic, Satellite & Wireless Communications, RF Engineering, Network Infrastructure, Telecom Power Systems, SMATV/MATV, and Maintenance & Technical Support across Ethiopia.";
  return {
    title,
    description,
    alternates: {
...
const SERVICES = [
  {
    ...
    highlights: [
      "BTS/NodeB/eNodeB/5G site installation",
  ...
  },
  {
    ...
    highlights: [
      "Underground and aerial fiber installation",
      "OTDR testing",
      "Fiber splicing and joint closure",
      "Last-mile fiber deployment",
    ],
  },
  {
    ...
    highlights: [
      "VSAT antenna installation and commissioning",
      "BUC/LNB replacement",
      "Microwave radio link installation",
      "RF troubleshooting",
    ],
  },
  {
    ...
    highlights: [
      "RF signal testing and measurement",
      "Spectrum analysis",
      "BUC, LNB & RF chain support",
  ...
  },
  {
    ...
    highlights: [
      "Cat6/Cat6A/Cat7 structured cabling",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Rectifier and UPS installation",
  ...
  },
  {
    ...
    highlights: [
      "SMATV and MATV system installation",
      "Headend equipment configuration",
      "RF signal testing and optimization",
      "Multiswitch and distribution equipment",
    ],
  },
  {
      ...
      <section className="relative py-24 overflow-hidden">
        <PageHeroCarousel
          slides={[
            ...
            {
              src: "/images/hero/services-page-hero/power-substation.webp",
              motion: "hero-drift-tr",
            },
            {
              src: "/images/hero/services-page-hero/power-towers-digital.jpg",
            ...
            {SERVICES.map((service, index) => {
              ...
              return (
                <div
                  ...
                  <div
                    className={`rounded-2xl overflow-hidden ${isEven ? "lg:order-1" : "lg:order-2"}`}>
                    <div className="relative h-80 lg:h-96">
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(to top, rgba(7,17,28,0.6) 0%, transparent 50%)",
                        }}
                      />
                    </div>
                  </div>

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    "GIX Nexus Telecom and Power serves 14 sectors: telecom operators, government ministries, ISPs, NGOs, UN agencies, banks, data centers, embassies, universities, and engineering contractors across Ethiopia.";
  return {
    title,
    description,
    alternates: {
...
export default async function Page({ params }: Props) {
  ...
  const sectors: Array<{ name: string; description?: string | null }> =
    cmsHasSectors ?
  ...
  return (
    <>
      <section className="relative py-24 overflow-hidden">
        <PageHeroCarousel
          slides={[
            ...
            {
              src: "/images/services/telecom-infrastructure.jpg",
        ...
        <div
          ...
          <p
            className="mt-5 max-w-2xl mx-auto text-sm italic leading-relaxed"
      ...
      {/* Industries/Sectors card grid (LAST SECTION before footer).
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {sectors.map((sector, i) => (
              <div
                ...
                <div
                  ...
                  style={{ background: "rgba(0,140,255,0.1)" }}>
          ...
          <div
            ...
            <h2
              ...
              style={{ color: "var(--foreground)" }}>
              Is Your Organization in One of These Sectors?
            </h2>
            <p
              className="text-sm mb-6 max-w-lg mx-auto"
              style={{ color: "var(--foreground-subtle)" }}>
              GIX Nexus Telecom and Power welcomes opportunities to work as a
              contractor or subcontractor across all of these sectors throughout
              Ethiopia.
            </p>
            <Link
              href={`/${locale}/contact`}

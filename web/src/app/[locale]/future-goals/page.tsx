...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    "GIX Nexus strategic objectives: expand operations across Ethiopia, build telecom partnerships, enhance technical capacity, achieve industry certifications, and support Ethiopia's digital transformation.";
  return {
    title,
    description,
    alternates: {
      ...
      languages: {
        en: `${BASE_URL}/en/future-goals`,
        am: `${BASE_URL}/am/future-goals`,
      },
    },
    openGraph: {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 text-center">
            <p
              ...
              style={{ color: "var(--foreground-subtle)" }}>
              GIX Nexus Telecom and Power is committed to sustainable growth and
              continuous improvement, becoming a trusted telecommunications and
              power engineering partner in Ethiopia and the East African region.
            </p>
            <Link
              href={`/${locale}/contact`}

  ...
  return (
    <header
      ...
      style={{
        ...
        background: scrolled ? 'rgba(10,37,64,0.94)' : '#0A2540',
        backdropFilter: scrolled ? 'blur(20px) saturate(1.6)' : 'none',
        WebkitBackdropFilter: scrolled ? 'blur(20px) saturate(1.6)' : 'none',
        borderBottom: '1px solid rgba(255,255,255,0.08)',
        boxShadow: scrolled ? '0 1px 0 rgba(255,255,255,0.04), 0 4px 20px rgba(10,37,64,0.3)' : 'none',
      ...
      >
          ...
          {navLinks.map((link) => (
            <li key={link.href}>
              <Link
                ...
                style={{
                  color: isActive(link.href) ? '#FFFFFF' : 'rgba(180,200,220,0.82)',
                  background: isActive(link.href) ? 'rgba(255,255,255,0.10)' : 'transparent',
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            style={{ borderColor: 'rgba(255,255,255,0.16)', color: 'rgba(180,200,220,0.82)' }}
          >

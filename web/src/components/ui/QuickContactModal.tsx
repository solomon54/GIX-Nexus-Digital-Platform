    ...
    <div
      ...
      <div
        style={{
          ...
          borderRadius: "16px",
          background:
            "linear-gradient(145deg, rgba(14,34,92,0.98) 0%, rgba(8,20,60,0.98) 100%)",
          border: "1px solid rgba(0,212,255,0.22)",
          boxShadow:
            "0 24px 80px rgba(0,0,0,0.70), 0 0 0 1px rgba(0,212,255,0.10)",
          overflow: "hidden",
          ...
          {state === "success" ?
            <div style={{ textAlign: "center", padding: "20px 0" }}>
              ...
              <p
                ...
                We received your message and will respond within 2 business
                days.
              </p>
              <button
                type="button"
          ...
          : /* ── Form ── */
            <form onSubmit={handleSubmit} noValidate>
                  ...
                  {state === "submitting" ?
                    <>
                      <svg
                        ...
                        style={{ marginRight: "8px", width: 14, height: 14 }}
              ...
              <p
                ...
                Or call us directly:{" "}
                <a href="tel:+251911509555" style={{ color: "var(--accent)" }}>
                  +251 911 509 555
                </a>
              </p>
            </form>

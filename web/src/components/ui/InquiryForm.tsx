  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setServerMessage(
          data.error ?? "Please correct the highlighted fields.",
        );
      } else {
        setState("error");
        setServerMessage(
      ...
      <div
        ...
        <div
          ...
          <p
            ...
            style={{ color: "var(--foreground-subtle)" }}>
            Fill in your details and we will respond within 2 business days. All
        ...
        <div className="px-7 py-6 space-y-6">
          {state === "error" && (
            <div
              ...
              style={{
                background: "rgba(216,58,58,0.06)",
                borderColor: "rgba(216,58,58,0.3)",
              }}>
              <span className="text-lg flex-shrink-0">⚠️</span>
              <p className="text-sm" style={{ color: "#D83A3A" }}>
                {serverMessage}
              </p>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                aria-describedby={
                  fieldErrors.contactName ? "err-name" : undefined
                }
              />
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                aria-describedby={
                  fieldErrors.organisation ? "err-org" : undefined
                }
              />
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <select
                ...
                aria-describedby={
                  fieldErrors.serviceType ? "err-service" : undefined
                }>
          ...
          <div>
            ...
            />
            {fieldErrors.message && (
              <p className="mt-1.5 text-xs" style={{ color: "#D83A3A" }}>
                {fieldErrors.message}
              </p>
            )}
          </div>
        ...
        <div
          className="px-7 py-5 border-t flex items-center justify-between gap-4"
          style={{
            borderColor: "var(--border)",
            background: "var(--soft-surface)",
          }}>
          ...
          <button
            ...
            style={{
              background:
                ...
                : "var(--accent)",
              color:
                state === "submitting" ? "var(--foreground-sub)" : "#050D1A",

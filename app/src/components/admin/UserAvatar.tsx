...
// Custom avatar for the top-right AppHeader account button.
// Shows the user's uploaded profile photo, or a teal gradient
// with their initials if no photo is set.
